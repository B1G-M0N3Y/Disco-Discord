...
def seed_chats():
    ...
    chat1.chat_members.append(user2)
    chat2.chat_members.append(user1)
    chat2.chat_members.append(user2)
    chat3.chat_members.append(user3)
    chat3.chat_members.append(user1)
    chat4.chat_members.append(user3)
    chat4.chat_members.append(user2)
    chat5.chat_members.append(user2)
    chat6.chat_members.append(user2)
    chat6.chat_members.append(user3)
    chat7.chat_members.append(user1)
    chat7.chat_members.append(user2)
    chat7.chat_members.append(user3)
